        ...
        <div className="z-[2] min-h-screen w-full max-w-[1280px] mx-auto px-[20px] xl:px-[0px] space-y-5 py-10 md:py-16">
          ...
          <div className="bg-[#e6e8f1] p-2 md:p-0 rounded-md z-10">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              {/* Search Icon & Input */}
              <div className="flex items-center flex-grow w-full md:w-auto px-4 relative">
                <IoSearchSharp
                  size={20}
                ...
                <input
                  ...
                  className="bg-transparent text-[#001571] text-base font-semibold flex-grow pl-4 py-3 pr-8 focus:outline-none placeholder-[#8A93BE] w-full"
                  value={searchQuery}
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-2 text-gray-400 hover:text-[#001571] transition-colors p-1"
              ...
              {/* Date Input */}
              <div className="w-full md:w-auto px-4 flex items-center gap-2">
                <input
                  type="date"
                  value={selectedDate}
                ...
                {selectedDate && (
                  <button
                    ...
                    className="text-gray-400 hover:text-[#001571] transition-colors p-1"
