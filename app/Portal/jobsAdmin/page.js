...
export default function Jobs() {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        setRecruiterDetails(recruiterData.recruiters);
        console.log("recruiter : ", recruiterData.recruiters);
      } catch (error) {
  ...
  const handleChange = (event) => {
    ...
    console.log("Selected recruiter:", event.target.value);
  };
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`mt-2 w-full border ${formErrors.recruiterId ? 'border-red-500' : 'border-gray-400'
                  ...
                  {formErrors.recruiterId && (
                    <p className="text-red-500 text-base mt-1">{formErrors.recruiterId}</p>
                  )}
                </div>
