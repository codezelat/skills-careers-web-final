        ...
        <>
            <div className="bg-white rounded-3xl py-7 px-7">
                ...
                <div className="flex flex-row w-full items-center justify-between mt-10 pb-5 border-b-2 border-[#B0B6D3]">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row items-center gap-10">
                            <h1 className="text-[24px] font-bold text-[#001571]">{editedJobDetails.jobTitle}</h1>
                            <div>
                                {editedJobDetails.jobTypes && editedJobDetails.jobTypes.map((type, index) => (
                                    <span
                                        key={index}
                        ...
                        <div className="text-base font-bold text-black">{recruiterDetails.recruiterName} | {editedJobDetails.location}</div>
                    </div>
                    <button
                ...
                <div className="flex flex-col w-full mt-10 pb-5 gap-5">
                    ...
                    <div className="text-base font-semibold">{editedJobDetails.shortDescription || "No perks & benefits available"}</div>
                </div>
                ...
                <div className="flex flex-col w-full mt-10 pb-5 border-b-2 border-[#B0B6D3] gap-5">
                    ...
                    <div className="text-base font-semibold">{editedJobDetails.keyResponsibilities || "No responsibilities available"}</div>
                </div>
                ...
                <div className="flex flex-col w-full mt-10 pb-5 border-b-2 border-[#B0B6D3] gap-5">
                    ...
                    <div className="text-base font-semibold">{editedJobDetails.requiredQualifications || "No qualifications available"}</div>
                </div>
                ...
                <div className="flex flex-col w-full mt-10 pb-5 gap-5">
                    ...
                    <div className="text-base font-semibold">{editedJobDetails.perksAndBenefits || "No perks & benefits available"}</div>
                </div>
            </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Job Profile</h4>
                            <button
            ...
            {editDescriptionForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Job Description</h4>
                            <button
            ...
            {editShortDescriptionForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Short Description</h4>
                            <button
            ...
            {editResponsibilitiesForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Key Responsibilities</h4>
                            <button
            ...
            {editQualificationsForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Required Qualifications</h4>
                            <button
            ...
            {editPerksForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div className="w-2/3 bg-white rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h4 className="text-2xl font-semibold text-[#001571]">Edit Perks & Benefits</h4>
                            <button
