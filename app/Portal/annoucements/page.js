...
export default function Annoucements() {
    ...
    const totalPages = Math.ceil(filteredAnnouncements.length / annoucementsPerPage);

    const indexOfLastAnnoucements = currentPage * annoucementsPerPage;
    const indexOfFirstAnnoucements = indexOfLastAnnoucements - annoucementsPerPage;
    const currentAnnoucement = filteredAnnouncements.slice(indexOfFirstAnnoucements, indexOfLastAnnoucements);
