...
export default function EditBenifits({ job, onClose }) {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white w-full max-w-4xl h-[90vh] overflow-y-auto rounded-xl shadow-md p-8 scrollbar-hide">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="benifits" className="block text-sm font-semibold text-[#001571]">
              Perks & Banifits
            </label>
            <textarea
               type="text"
               name="benifits"
               required
               value={jobDetails?.perksAndBenefits || ""}
