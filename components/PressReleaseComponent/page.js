        ...
        <div className="h-full grid lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-1 lg:gap-4 md:gap-4 sm:gap-0">
          ...
          <div className="lg:col-span-4 md:col-span-4 sm:col-span-1 bg-slate-100 mb-4 p-6 rounded-lg shadow-md">
            ...
            {selectedPressrelease ? (
              // Show the ViewPressrelease component if a press release is selected
              <ViewPressrelease
                pressrelease={selectedPressrelease}
                onClose={handleClosePressrelease}
              />
            ) : (
              // Show the grid of press releases if no press release is selected
