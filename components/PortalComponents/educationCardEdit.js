    ...
    if (isEditing) {
        return (
            <form onSubmit={handleUpdate} className="py-4 border-b-2 space-y-4">
                <div>
                    <label className="block text-sm font-semibold text-[#001571]">Education Qualification</label>
                    <input
                        type="text"
                        name="educationName"
                ...
                <div>
                    <label className="block text-sm font-semibold text-[#001571]">Organization</label>
                    <input
                        type="text"
                        name="location"
