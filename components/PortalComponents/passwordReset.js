...
export default function PasswordReset({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white w-full max-w-4xl overflow-y-auto rounded-xl shadow-md p-8 scrollbar-hide">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {success && <p className="text-green-500 text-base">Password updated successfully!</p>}

                    <div>
                        <label htmlFor="oldPassword" className="block text-base font-semibold text-[#001571]">
                            Old Password
                        </label>
                        <input
                            type="password"
                    ...
                    <div>
                        <label htmlFor="newPassword" className="block text-base font-semibold text-[#001571]">
                            New Password
                        </label>
                        <input
                            type="password"
